...
/**
 * Generated class for the EngIceMakerPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-eng-ice-maker',
  templateUrl: 'eng-ice-maker.html',
})
export class EngIceMakerPage {
  ...
  constructor(
    ...
    public engIceMakerService: EngIceMakerService,
  ...
  getRecords() {
    this.showLoader()
    this.engIceMakerService.getRecordByDate(this.date)
      .then((result: any) => {
        console.log(result)
    ...
    let confirm = this.alertCtrl.create({
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: () => {
            this.showLoader();
            this.engIceMakerService.deleteRecord(recorder.id)
              .then(result => {
                this.dismissLoader();
                this.getRecords();
