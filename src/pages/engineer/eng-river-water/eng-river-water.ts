...
/**
 * Generated class for the EngRiverWaterPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-eng-river-water',
  templateUrl: 'eng-river-water.html',
})
export class EngRiverWaterPage {
    ...
    let confirm = this.alertCtrl.create({
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: () => {
            this.showLoader();
            this.engRiverWaterService.deleteRecord(recorder.id)
              .then(result => {
                this.dismissLoader();
                this.getRecords();
