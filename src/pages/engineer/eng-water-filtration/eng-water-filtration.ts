...
/**
 * Generated class for the engWaterFiltrationServiceServicePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-eng-water-filtration',
  templateUrl: 'eng-water-filtration.html',
})
export class EngWaterFiltrationPage {
    ...
    let confirm = this.alertCtrl.create({
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: () => {
            this.showLoader();
            this.engWaterFiltrationService.deleteRecord(recorder.id)
              .then(result => {
                this.dismissLoader();
                this.getRecords();
